class CreateFlowElementDownstreamCircuitPipings < ActiveRecord::Migration
  def self.up
    create_table :flow_element_downstream_circuit_pipings do |t|
  ...
  def self.down
    drop_table :flow_element_downstream_circuit_pipings
  end
end
