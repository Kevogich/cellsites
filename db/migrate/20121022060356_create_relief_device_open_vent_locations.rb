class CreateReliefDeviceOpenVentLocations < ActiveRecord::Migration
  def self.up
    create_table :relief_device_open_vent_locations do |t|
  ...
  def self.down
    drop_table :relief_device_open_vent_locations
  end
end
