class CreateReliefDeviceRuptureLocations < ActiveRecord::Migration
  def self.up
    create_table :relief_device_rupture_locations do |t|
  ...
  def self.down
    drop_table :relief_device_rupture_locations
  end
end
